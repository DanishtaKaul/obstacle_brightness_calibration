...
4. The obstacle is shown at that average shade and lowered in brightness until the participant can no longer see it (visibility threshold).
5. The difference between the average shade and the visibility threshold is added back onto the average to give the final calibrated obstacle shade.
